...
public class ThreadTest {
        ...
        void threadSleep() throws InterruptedException {
          ...
          Thread.sleep(3_000L); //main thread nunggu-in si Thread-0
        }
          ...
          Runnable runnable = () -> {
            for (int i = 0; i < 10; i++) {
              ...
              try {
                ...
                e.printStackTrace(); // hanya nangkap pesan error, namun tidak memberhentikan 
              }
            }
          };
        ...
        void threadInterruptCorrect() throws InterruptedException {
          ...
          thread.start();
          Thread.sleep(5_000);
          thread.interrupt(); // mengirim sinyal agar thread diberhentikan 
          System.out.println("Menunggu Selesai");
          thread.join();
          System.out.println("Program Selesai");
        }
        ...
        void threadName() {
          ...
          thread.setName("Eko"); //mengubah nama thread
          thread.start();
        }
        ...
        void threadState() throws InterruptedException {
          var thread = new Thread(() -> {
            System.out.println(Thread.currentThread().getState()); //NEW
            System.out.println("Run in thread : " + Thread.currentThread().getName());
          });
          thread.setName("Eko");
